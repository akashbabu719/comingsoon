...
const data = {
	"en": {
	  ...
	  "servicesDesc": "Discover Our Services: At our Hausarztpraxis, we offer a comprehensive range of top-notch medical services, backed by a team of experienced professionals and state-of-the-art facilities. From preventive care to advanced treatments, we are committed to providing the highest level of healthcare and improving the well-being of our patients.",
	  "timingHeader": "Timing",
	  "teamHeaderh2": "Dedicated Hausarztpraxis practice team providing exceptional care and expertise to patients.",
	  "galleryH2": "Gallery",
	  "galleryh2desc": "Discover our Hausarztpraxis image gallery, displaying compassionate care, modern facilities, and our medical team's expertise dedicated to your well-being.",
	  "galleryDesc": "Explore our Hausarztpraxis image gallery, showcasing our compassionate care and modern facilities. Witness the expertise of our medical team as they prioritize your well-being and deliver top-notch services to our valued patients.",
	  "imprint": "Imprint/Data protection",
	  "practiceTeamHeader": "Meet Our Practice Team",
	  "practiceTeamBody": "We take pride in our exceptional team of healthcare professionals. Our practice team is composed of highly skilled and compassionate doctor, nurses/MFA's, and support staff who are dedicated to providing the best possible care to our patients. Each member of our team brings a wealth of experience and expertise, ensuring that you receive personalized and top-notch medical attention. We are committed to your well-being and look forward to serving you with the utmost care and professionalism.",
